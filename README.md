...
| 기사 | `/driver` | ★ 차량 배정 · 운행 시작(GPS 전송) · 도착 · 하역 완료 |
...
| 이어치기 공백 기준점 | KCS 14 20 10 표 3.3-1 값(120/150분)은 원문 확인 완료. 다만 공백을 「타설 종료~다음 차 도착」으로 잼 | 원문은 「하층 비비기 시작~상층 타설」 기준. 시작점을 맞춰야 함 |
